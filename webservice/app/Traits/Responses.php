...
trait Responses
{
     ...
     * @return \Illuminate\Http\Response
     */
    protected function responseWithUnprocessableEntity($message = 'Error')
    {
        return $this->setStatusCode(Response::HTTP_UNPROCESSABLE_ENTITY)->responseWithError($message);
    }
